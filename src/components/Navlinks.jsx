...
import { loadTest, testClick } from '../redux/slices/tweetsSlice'

export const Navlinks = () => {

    const testCount = useSelector(loadTest);
  ...
  return (
    <nav className="mainlinks">
                            ...
                            <a href="/">
                                <div className="link">
                                    <div className="icon"><svg viewBox="0 0 24 24" aria-hidden="true" className="svg">
                                            <g>
                                                <path
