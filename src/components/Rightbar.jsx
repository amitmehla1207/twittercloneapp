                            ...
                            <div className="searchbox">
                                <form>
                                    <div className="searchinput">
                                        <div className="serachicon"><svg viewBox="0 0 24 24" aria-hidden="true"
                                                className="searchsvg">
                                                <g>
                                                    <path
                    ...
                    <div className="box">
                            ...
                            <div className="rec-list">
                                ...
                                <div className="rec-list-right">
                                    <div className="rec-details">
                                        <a href="/" className="user-name">Amit Kumar</a>
                        ...
                        <div className="list">
                            <div className="rec-list">
                                ...
                                <div className="rec-list-right">
                                    <div className="rec-details">
                                        <a href="/" className="user-name">John Smith</a>
                        ...
                        <div className="list">
                            <div className="rec-list">
                                ...
                                <div className="rec-list-right">
                                    <div className="rec-details">
                                        <a href="/" className="user-name">Elon Musk</a>
